...
session_start();
//koneksi ke database
$koneksi = new mysqli("localhost", "root", "", "agussenin");
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Resiskom Cloth</a>
            </div>
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    <li class="text-center">
                        <img src="assets/img/gambar1.png" class="user-image img-responsive" />
                    </li>
